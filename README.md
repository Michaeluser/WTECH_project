...
- **Odovzdanie 1. fázy projektu: koniec 6. týždňa - 29.3. do 23:59 v AIS, 24 bodov,**
...
- **Odovzdanie 2. fázy projektu: koniec 12. týždňa - 10.5. do 23:59 v AIS, 24 bodov**
...
- košík - 4 body
  ...
  - doprava/platba
  - údaje (s validáciou)
- prenositeľnosť košíka (prihlásený, nepríhlásený používateľ) - 3 body
- zákazník - 1 bod
